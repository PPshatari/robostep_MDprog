...
public:
    ...
    */
    ...
    void setGearRatio(double gear_ec);
...
public:
    ...
    * 使うエンコーダの数だけ設定する必要がある
    ...
    @ remark 2,4逓倍も同様
    */
    Ec1multi(PinName signalA,PinName signalB,int res,double gear_ec);
};
...
public:
    ...
    * 使うエンコーダの数だけ設定する必要がある
    ...
    @ param res エンコーダの分解能
    */
    Ec2multi(PinName signalA,PinName signalB,int res,double gear_ec);
};
...
public:
    ...
    * 使うエンコーダの数だけ設定する必要がある
    ...
    @ param res エンコーダの分解能
    */
    Ec4multi(PinName signalA,PinName signalB,int res,double gear_ec);
};
