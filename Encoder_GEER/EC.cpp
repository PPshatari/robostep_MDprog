...
Ec::Ec(int res,int multi):
    count_(0),pre_omega_(0),pre_count_(0),resolution_(res),multiplication_(multi)
{
    timer_.start();
}
...
{
    return count_*2.0f*M_PI/(multiplication_*resolution_*geer_ratio);
}
double Ec::getDeg()const
{
    return count_*2.0f*180.0/(multiplication_*resolution_*geer_ratio);
}
void Ec::calOmega()
{
...
void Ec::setGearRatio(double gear_ec)
{
    geer_ratio=gear_ec;
}
...
////////////////////////////////////////////////////1逓倍//////////////////////////////////////////////////////////////////
Ec1multi::Ec1multi(PinName signalA,PinName signalB,int res,double gear_ec) : Ec(res,1),signalA_(signalA),signalB_(signalB)
{
    signalA_.rise(callback(this,&Ec1multi::upA));
    setGearRatio(gear_ec);
}
...
////////////////////////////////////////////////////2逓倍//////////////////////////////////////////////////////////////////
Ec2multi::Ec2multi(PinName signalA,PinName signalB,int res,double gear_ec) : Ec(res,2),signalA_(signalA),signalB_(signalB)
{
...
////////////////////////////////////////////////////4逓倍//////////////////////////////////////////////////////////////////
Ec4multi::Ec4multi(PinName signalA,PinName signalB,int res,double gear_ec) : Ec(res,4),signalA_(signalA),signalB_(signalB),pa_(0),pb_(0)
{
